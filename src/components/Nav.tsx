  ...
  return (
    <div className="bg-[#fffffc] sticky top-0 border-b border-gray-100">
      <div className="max-w-4xl mx-auto flex justify-between items-center mt-1.5 md:py-5 py-6 md:px-12 px-6 md:rounded-xl">
        ...
        <div
          className={`translate-x transition-all duration-300 min-h-screen w-full fixed top-0 ${menu ? "left-0" : "left-200"} bg-white md:hidden flex flex-col px-6 py-8`}
        >
            ...
            <button
              ...
              onClick={() => {
                fetch(`${backendUrl}/api/user/logout`, {
                  ...
                  res.ok ? navigate("/") : console.log(res.json()),
                );
              }}
            >
              Logout
